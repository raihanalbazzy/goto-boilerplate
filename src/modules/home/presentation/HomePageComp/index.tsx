...
import { HomePageCompProps } from "./models/types";

const mainClass = cva(
  "flex min-h-[50vh] flex-col items-center justify-centerr  p-24",
  {
...
export default function HomePageComp({
  ...
  return (
    <main className={mainClass({ isServer })}>
      <h1 className="text-white font-bold">Goto BoilerPlate</h1>
